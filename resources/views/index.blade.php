        ...
        <div class="row ">
            ...
            <div class="col-lg-3">
                ...
                <div class="list-group">
                    <li class="list-group-item active">Categoreis</li>
                    ...
                    @foreach ($products as $product)
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="card h-100">
                                <a href="#"><img class="card-img-top img-thumbnail" src="{{ url($product->img_path) }}"
                                ...
                                <div class="card-footer btn-success">
                                    <a class="btn text-black" href="{{ route('cart') }}" onclick="event.preventDefault();
